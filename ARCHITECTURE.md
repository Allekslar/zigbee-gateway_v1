...
15. **Telemetry Semantics in Service** — Zigbee raw reports are normalized in Service to domain telemetry events (e.g. `0x0402/measuredValue` in 0.01°C with invalid marker handling, `0x0406/occupancy` with debounce/hold policy), Core consumes only normalized payload.
